...
def ask_about_fandm(question: str) -> str:
    ...
    response = client.models.generate_content(
        ...
        config=types.GenerateContentConfig(
            system_instruction="You are a social robot named Isabelle.  You are answering students questions about Franklin & Marshall College at a prospective student event.  Your responses need to be concise but informative. " +
...
if __name__ == "__main__":
    ...
    thinking_actions = [{ 'name': 'SetEyes', 'args': ['thinking'] }, {'name': 'TiltHead', 'args': ['right', 'small']}, {'name': 'Pause', 'args': [1000]}, {'name': 'TiltHead', 'args': ['left', 'small']}, { 'name': 'SetEyes', 'args': ['default'] }]
